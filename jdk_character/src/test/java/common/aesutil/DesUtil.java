...
public class DesUtil {
    ...
    public static String desEncode(String res) {
        return keyGeneratorEs(res, DES, Md5Util.getStringMd5("EY8WePvjM5GGwQzn"), keysizeDES, true);
    }
    ...
    public static String desDecode(String res) {
        return keyGeneratorEs(res, DES, Md5Util.getStringMd5("EY8WePvjM5GGwQzn"), keysizeDES, false);
    }
    ...
    public static String aesEncode(String res) {
        return keyGeneratorEs(res, AES, Md5Util.getStringMd5("EY8WePvjM5GGwQzn"), keysizeAES, true);
    }
    ...
    public static String aesDecode(String res) {
        return keyGeneratorEs(res, AES, Md5Util.getStringMd5("EY8WePvjM5GGwQzn"), keysizeAES, false);
    }
