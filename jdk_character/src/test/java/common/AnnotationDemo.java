...
public class AnnotationDemo {
    public static void main(String[] args) {
         ...
         */
        OutstandStudent student = new OutstandStudent();
        student.setAge(2);
         ...
         * 校验框架会对 name字段进行非空校验
         */
        OutstandStudent student1 = new OutstandStudent();
        student1.setAge(7);
         ...
         */
        OutstandStudent OutstandStudent = new OutstandStudent();
        OutstandStudent.setAge(7);
        OutstandStudent.setStudentNo("abcde" );
        OutstandStudent.setName("测试小学生" );
        OutstandStudent.setEmail("1123154@163.com" );
        try {
            ValidateUtils.check(OutstandStudent);
        } catch (Exception e) {
            System.out.println(e);
        }
         ...
         */
        OutstandStudent student3 = new OutstandStudent();
        student3.setAge(7);
