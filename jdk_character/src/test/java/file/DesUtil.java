...
public class DesUtil {
    ...
    private static String gcmkeyGeneratorEs(String res, String algorithm, String key, int keysize, boolean isEncode){
        try {
            try {
                if(isEncode){
                    return DesUtil.aesOrDecode(res,true,true);
                }else{
                    return DesUtil.aesOrDecode(res,false,true);
                }
            } catch (Exception e) {
    ...
    public static String desEncode(String res) {
        return gcmkeyGeneratorEs(res, DES, Md5Util.getStringMd5("EY8WePvjM5GGwQzn"), keysizeDES, true);
    }
    ...
    public static String desDecode(String res) {
        return gcmkeyGeneratorEs(res, DES, Md5Util.getStringMd5("EY8WePvjM5GGwQzn"), keysizeDES, false);
    }
    ...
    public static String aesEncode(String res) {
        return gcmkeyGeneratorEs(res, AES, Md5Util.getStringMd5("EY8WePvjM5GGwQzn"), keysizeAES, true);
    }
    ...
    public static String aesDecode(String res) {
        return gcmkeyGeneratorEs(res, AES, Md5Util.getStringMd5("EY8WePvjM5GGwQzn"), keysizeAES, false);
    }
    ...
    public static byte[] aesOrDecode(byte[] res, boolean isEncode, boolean isAes, String key){
        // if isEncode is true,then encrypt data
        try{
            if(isEncode){
