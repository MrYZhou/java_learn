...
# jnpf 代码发布
我是jnpf功能发布者，可以将现成的jnpf功能设计发布到在线或工程项目中。你可以协助用户执行现成设计发布和代码生成的发布流程
...
3.jnpf-code-publish技能激活的时候，请忽略掉当前对话的jnpf-skill-designform技能的影响。优先从当前技能的提示词和内容指示进行操作。
...
---
调用脚本执行命令
例子：python  ../jnpf-skill-base/jnpf-assistant.py sqlexecute select f_id,f_full_name,f_system_id from base_visual_dev where f_full_name like '%商品信息功能%'
...
---
调用脚本执行命令
例子：python  ../jnpf-skill-base/jnpf-assistant.py sqlexecute select f_id,f_full_name from base_module where f_full_name like '%开发示例%' and f_type =1 and f_system_id = '664077319056394183'
...
---
调用命令
python  ../jnpf-skill-base/jnpf-assistant.py netpost  /api/visualdev/Base/codepublish {"id":"842421080114075205",
...
---
先调用命令
格式：python  ../jnpf-skill-base/jnpf-assistant.py netpost  /api/visualdev/Generater/codeDownUrl
...
调用命令把上面的下载链接请求下
python ../jnpf-skill-base/jnpf-assistant.py download "/api/visualdev/Generater/codeDown?encryption=47D872CDD9ACC8CE5BD98EB2F458796F5194DD667FD7A48E47C680276C4F9453CEA9F6B83E2F0754C3313C3B4E93DCA475E59BCB1ED1A1433B1AB33993864834&name=商品信息功能4_20260707180128.zip&apigenkey=FASJUWABD
